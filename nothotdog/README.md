As a fan of Silicon Valley I found a project where someone on hugging face uploaded a ML model that identifies whether a hot dog is in indeed an hot dog when uploading images. 
